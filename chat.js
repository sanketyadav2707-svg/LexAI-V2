...
function renderAppStates() {
    ...
    if (State.currentUser) {
        welcomeContainer.innerHTML = `${svgIcon}
            ...
            <p class="text-[var(--text-muted)] text-base md:text-xl max-w-md mx-auto anim-fade-up anim-delay-1">How can I help you today?</p>`;
    } else {
        welcomeContainer.innerHTML = `${svgIcon}
...
/* ═══════════════════════════════════════════
   3. MULTI-FILE & COMPRESSION PROCESSOR
═══════════════════════════════════════════ */
const DocProcessor = {
